    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">My Students</h2><br>
            </div>
            <?php $count = 0;
                ...
                while($row = mysqli_fetch_row($result)){
                  ...
                  echo '<p class="pad_bot1 pad_top2">'.$row[3].' years old</p>';
      ...
      ?>
          ...
          <article class="col2 pad_left2">
            ...
            <ul class="list1 pad_bot1">
              ...
              <li><a href="viewAssignments?login=<?php echo $username; ?>">View Assignments</a></li>
              <li><a href="writeReport?login=<?php echo $username; ?>">Write Report</a></li>
              <li><a href="viewQuestions?login=<?php echo $username; ?>">View Questions</a></li>
