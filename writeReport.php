...
<html lang="en">
<head>
<title>Learn Center | Post Report</title>
<meta charset="utf-8">
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">Write Report</h2><br>
            </div>
            <form id="ContactForm" action ="action.php?login=<?php echo $username; ?>" method="post">
                  <div  class="wrapper"> <strong>Content:</strong>
                    <div class="bg">
                      <input type="text" name ="h_repCon" class="input" maxlength="50" required="">
                    </div>
                  </div>
                  <div  class="wrapper"> <strong>Your Comment: </strong>
                    <div class="bg">
                      <input type="text" name ="h_repComment" class="input" maxlength="50" required="">
                    </div>
                  </div>
                  <div  class="wrapper"> <strong>Students: </strong> 
                    <div class="bg">
                      <select name="h_rssn">
                      <?php $tmp = mysqli_query($conn, "call view_My_Students('$id')");
                         if (!$tmp) {
                  ...
                  <input type="submit" name ="h_write"  class="button" value = "Post Report"></input>
            </form>
          </article>
