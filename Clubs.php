...
<html lang="en">
<head>
<title>Learn Center | Clubs</title>
<meta charset="utf-8">
        ...
        <div class="wrapper">
          <article class="col1">
            ...
            ?>
                    ...
                    <input type="submit" name ="ms_club" class="button" value = "Join"></input>
                  </div>
                  </form>
                
<?php
                include 'database.php';
                $result = mysqli_query($conn, "call view_Club($ssn)"); 
                while($row = mysqli_fetch_row($result)){

			         	echo '<div class="wrapper pad_bot2">';
                echo '<p class="pad_bot1 pad_top2"><strong>Name: </strong>'.$row[1].'<br></p>';
                echo '<p class="pad_bot1 pad_top2"><strong>Purpose : </strong>'.$row[2].'</p></div>';
