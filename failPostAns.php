...
<html lang="en">
<head>
<title>Learn Center | Post Answer</title>
<meta charset="utf-8">
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">Posting Answer for the Question failed! Please try again!</h2>
              <form method = "post" action="viewQuestions.php?login=<?php echo $username; ?>"><input type="submit" class = 'button' value="Back"></form>
            </div>
