<?php include 'database.php'; 
      ...
      define("link2", "admin_postNewAnnouncement.php?login=".$username);
?>
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">Create New Activity</h2>
            </div>
            <div class="pad_left1">
            ...
            <p class="pad_bot1 pad_top2"><strong> </strong>
             ...
             <form  action ="admin_action.php?login=<?php echo $username; ?>" method="post">
                     <div  class="wrapper"> <strong>Activity Name:</strong> </div>
                     <div>
              <input type="text" name ="la_acname" class="input" maxlength="30" style = "border:1px solid #000000; width: 250px; height: 20px" required="" > </input> </div>
               <div  class="wrapper"> <strong> </strong> </div>

                     <div  class="wrapper"> <strong>Activity Type:</strong> </div>
                     <div>
              <input type="text" name ="la_actype" class="input" maxlength="30" style = "border:1px solid #000000; width: 250px; height: 20px" required="" > </input> </div>
              <div  class="wrapper"> <strong> </strong> </div>

                     <div  class="wrapper"> <strong>Activity Date:</strong> </div>
                     <div>
              <input type="date" name ="la_acdate" class="input" maxlength="30" style = "border:1px solid #000000; width: 250px; height: 20px" required="" > </input> </div>
              <div  class="wrapper"> <strong> </strong> </div>

                     <div  class="wrapper"> <strong>Activity Location:</strong> </div>
                     <div>
              <input type="text" name ="la_acloc" class="input" maxlength="50" style = "border:1px solid #000000; width: 250px; height: 20px" required="" > </input> </div>
              <div  class="wrapper"> <strong> </strong> </div>  


                  <div  class="wrapper"> <strong>Activity Description:</strong> </div>
                     <div>
                     <textarea name="la_acdesc" rows="6" cols="50" maxlength="300" style = "border:1px solid #000000">
                     </textarea> </div>
              <div  class="wrapper"> <strong> </strong> </div>
              <span><span><input type="submit" name ="la_submitAc"  class="button" value = "Submit"></input></span></span>
              </form>
              </div>
