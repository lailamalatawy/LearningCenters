...
<html lang="en">
<head>
<title>Learn Center | Post Assignment</title>
<meta charset="utf-8">
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">Posting Assignment failed! Please try again!</h2>
              <form method = "post" action="viewAssignments.php?login=<?php echo $username; ?>"><input type="submit" class = 'button' value="Back"></form>
            </div>
