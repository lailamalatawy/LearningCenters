...
<?php 
    ...
    function list_schools() {
      ...
      $output = "";
	  $result = mysqli_query($conn, "SELECT school_id, name, email FROM Schools;") or die('cannot show tables');       
          ...
          <article class="col1">
            ...
            <div class="pad_left1">
             <!-- <figure class="left marg_right1"><img src="images/page2_img1.jpg" alt=""></figure> -->
              ...
              <input type="text" name ="la_schoolid" class="input" maxlength="10" style = "border:1px solid #000000; width: 50px; height: 20px" required="" > </p></input>
              </form>
