<?php include 'database.php'; 
      ...
      define("link2", "admin_createNewActivity.php?login=".$username);
?>
...
<?php 
    ...
    die("Could not connect:"  . mysqli_connect_error()); } 
      ...
      $output = "";
    $result = mysqli_query($conn, "SELECT activity_id,activity_name,activity_date FROM Activities WHERE administrator_id = 16;") or die('cannot show tables'); // CHANGE THAT LATER      
        ...
        <div class="wrapper">
          <article class="col1">
            ...
            <p class="pad_bot1 pad_top2"><strong> </strong>
              ...
              <div class="box2">
                <div class="wrapper">
                <table cellpadding="50" cellspacing="500" width=x"100%" class="sortable">
                    <thead>
                         <tr valign="middle">
                                <th>ID</th>
                                <th>Name</th>
