...
<?php 
    ...
    while ($row = mysqli_fetch_array($result)){
      ...
      <td>' . $row['email'] . '</td> 
      <td> <form  action ="admin_action.php" method="post">
           <span><span><input type="submit" name ="la_verifyTeacher' . $val . '"  class="button" value = "Verify"></input></span></span>
           </form> 
      </td>
      </tr>';
      $val = $val+1;
          ...
          <article class="col1">
           ...
           <article class="col2 pad_left2">
            ...
            <ul class="list1 pad_bot1">
              <li><a href="admin_verifyTeachers.php?login=<?php echo $username; ?>">Verify Teachers</a></li>
