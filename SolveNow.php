    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">Solve Assignment</h2>
            </div>
            
            <form id="ContactForm" action ="m_solved.php?login=<?php  echo $username?>&course=<?php  echo $course?>&id=<?php  echo $id?> "  method="post">                              
                <div>
                 
                  <div  class="wrapper"> <strong>Solution:</strong>
                    <div class="bg">
                      <input type="text" name ="ms_sol" class="input" maxlength="200">
                    </div>
                  </div>
                  
                  <span><span><input type="submit" name ="ms_solve" class="button" value = "Submit"></input> </span></span>
                  </form>
